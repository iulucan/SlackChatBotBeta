"""
policy_tool.py — GreenLeaf Bot | Policies Tool
================================================
...
Architecture position (HLD):
    brain.py → policy_tool.py → ChromaDB (vector_store/)
                    ↓
...
def ingest_handbook(path: str = HANDBOOK_PATH) -> dict:
    ...
    Run this once after cloning the repo:
        python src/tools/policy_tool.py --ingest
...
if __name__ == "__main__":
    ...
    if "--ingest" in sys.argv:
        ...
        print("Usage: python src/tools/policy_tool.py --ingest")
...
#
# 3. Test the queries:
#    python tests/test_policy_tool.py
#
# Expected results:
